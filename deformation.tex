...
\end{equation}
where $\Phi(0)$ is the matrix for the action of $p^{-1} \Frob_p$ 
...
was given by Lauder~\citep[Theorem~5.1]{Lauder2006}, but this can be improved significantly by including 
