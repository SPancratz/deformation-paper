...
\begin{align*}
\abs{V \cap (H_0 \cup \dotsb \cup H_n)} &= \sum_{j=0}^n \abs{V \cap H_j} - \sum_{0 \leq j < k \leq n} \abs{V \cap H_j \cap H_k}
+ \dotsb + (-1)^{n} \abs{V \cap H_0 \cap \dotsb \cap H_n} \\
&= {n+1 \choose 1} d^{n-1} -{n+1 \choose 2} d^{n-2} + \dotsb + (-1)^{n-1} {n+1 \choose n} + (-1)^{n} \\
