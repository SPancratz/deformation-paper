...
considering as input variables $n$, $d$, $\log p$, and 
$a = \log_p \mathfrak{q}$.  We use the $\SoftOh(-)$ notation that ignores 
logarithmic factors, i.e.\ $\SoftOh(f)$ denotes the class of functions 
