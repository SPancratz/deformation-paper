...
\ord_p(a_{i,j}) \geq c(i+j)  
\biggr\}
\]
for the ring of $p$-adically meromorphic functions on $\mathbf{P}^1_{\QQ_q}$, 
that are analytic outside of the union of the open disks of radius $\rho$
around the zeroes of $r$ and the point at infinity, for some $\rho<1$. 
\end{defn}
