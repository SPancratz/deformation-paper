...
and $\theta_{\infty}=9$ at $\infty$. At the zeros $z$ of $r_1$, noting that 
$R$ has no other zeros in the residue disk at $z$, we get a better bound by applying 
...
\end{split}
\end{equation*}
and we take $\tau$ to be  $1$. 

\subsubsection{Precisions}

We first compute $\delta=0$ and $N_{\Phi}=N_{\Phi}'=$.
