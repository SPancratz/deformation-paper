...
out on a laptop with two Intel Core i7-3540M processors running at 3GHz and with 8Gb of RAM, but only used 
a single processor and no more than about 1.5 Gb of RAM. Timings
are obtained using the C function clock() and are stated in minutes (m) or seconds (s). We are still
working on improving the implementation and hope to include updated timings in the final version of this paper.
