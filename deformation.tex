...
Note that we can (and will) take $\theta_z=0$ if the connection matrix $M$ 
does not have a pole at $z$, so that $\theta_z$ vanishes for all but finitely 
many $z$. We now define 
\begin{align*}
