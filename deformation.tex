...
\biggr\}
\]
for the ring of overconvergent functions, i.e. $p$-adically meromorphic functions on 
$\mathbf{P}^1_{\QQ_q}$ that are analytic outside of the open disks of 
radius $\rho$, around the zeroes of $r$ and the point at infinity, for some $\rho<1$. 
\end{defn}
