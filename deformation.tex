...
take $s=r_1 r_2^{660}$ and $K=31720$. We now compute the remaining $p$-adic precisions 
...
brings the degree of $s$ down to $8498$. Note that this does require factorizing the polynomials $\det(\Delta_2)$, 
...
so that we can take $K=8495$. We now compute the remaining $p$-adic precisions 
