...
some Zariski open subset $\mathcal{S} \subset \mathbf{P}^1_{\ZZ_q}$, defined
...
The last equality can be checked at the diagonal fiber. Therefore, there is no precision loss 
