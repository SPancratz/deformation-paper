...
our runtimes to the ones in \cite{Gerkmann2007}. 
...
since for the matrix $\Psi$ of $p^{-1}\Frob_p$ with respect to 
$[w_1,\ldots,w_b]$ we only have that $\ord_p{\Psi} \geq -\delta'$. 
\end{rem}
