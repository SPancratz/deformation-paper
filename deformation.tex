...
in Algorithm~\ref{alg:expansion} then takes
\begin{align*}
...
\end{equation*}
Applying $\sigma$ to the matrix $C^{-1}$ now takes time 
\begin{equation*}
...
\end{equation*}
The time complexity is therefore dominated by the computation of 
the matrix $C$.

The space requirement is dominated by that of the matrix~$C$, which has size
\begin{equation*}
