...
$\QQ_{q}$ where the modulus is the defining polynomial for the extension 
$\QQ_{\mathfrak{q}} / \QQ_{q}$, which is of degree $a/a'$. However, 
care has to be taken to include the additional reduction of the 
polynomials of degree less than~$K$ modulo the defining polynomial, so that polynomials involved in the composition have degree 
less than~$a/a'$.  Thus, the substitutions require time 
\begin{equation*}
\SoftOh\Bigl( b^2 \bigl(K a' \log(p) (a d^n) + \tfrac{a}{a'} \log(p) a' (a d^n) \bigr)
