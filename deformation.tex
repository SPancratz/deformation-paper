...
Moreover, it is known~\citep{Williams2012} that $2 \leq \omega \leq 2.3729$.  Finally, we 
...
Our timings in this example seem to confirm that the running time of the algorithm is quasilinear in $p$, although $2^9+9$ is
