...
a pole at $z$, so that $\gamma_z$ vanishes for all but finitely many $z$. We now define 
\begin{align*}
...
We find $\gamma_z=320$ at all zeroes of $r$ and $\gamma_{\infty}=12$, so that we
...
we find $\mu=0$, $\nu=-1$, $\gamma_z=397$ and at $\infty$ we find 
$\mu=-3$, $\nu=-2$, $\gamma_{\infty}=793$, so that we obtain $K=2779$ for the
...
We find $\gamma_z=224$ at all zeroes of $r$ and $\gamma_{\infty}=25$, so that we
...
$\tau=\alpha^{2345}$. Note that a priori the sign of the functional equation is 
unknown, so that we have to compute all the coefficients of $\chi(T)$. \\  
